...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE/eksternal/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE/eksternal/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE/dist/css/AdAdminLTE.min.css">
    <!-- iCheck -->
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url(); ?>AdminLTE/index2.html"><b>Admin</b>Sistem Perpustakaan</a>
      </div>
